...
static gf11_t gf11_index[GF11_ELEMENT]; /* table for ind */
static gf11_t gf11_power[GF11_ELEMENT]; /* table for pow */
static gf11_t gf11_reciprocal[GF11_ELEMENT]; /* table for reciprocal number */
